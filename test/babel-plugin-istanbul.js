...
import * as babelV8 from '@babel/core-v8'
...
const babelVersions = [
  { version: 7, babel },
  { version: 8, babel: babelV8 }
]

for (const { version, babel } of babelVersions) {
  describe(`babel-plugin-istanbul with babel v${version}`, function () {
    ...
    // regression test for https://github.com/istanbuljs/babel-plugin-istanbul/issues/78
      ...
      // TODO: run these tests against babel v8
      if (version === 7) {
